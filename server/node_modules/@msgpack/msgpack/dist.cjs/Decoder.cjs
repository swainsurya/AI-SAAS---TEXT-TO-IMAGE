...
require("./utils/symbol.dispose.cjs");;
const prettyByte_1 = require("./utils/prettyByte.cjs");;
const ExtensionCodec_1 = require("./ExtensionCodec.cjs");;
const int_1 = require("./utils/int.cjs");;
const utf8_1 = require("./utils/utf8.cjs");;
const typedArrays_1 = require("./utils/typedArrays.cjs");;
const CachedKeyDecoder_1 = require("./CachedKeyDecoder.cjs");;
const DecodeError_1 = require("./DecodeError.cjs");;
...
class Decoder {
    constructor(options) {
        ...
        this.maxStrLength = options?.maxStrLength ?? int_1.UINT32_MAX;
        this.maxBinLength = options?.maxBinLength ?? int_1.UINT32_MAX;
        this.maxArrayLength = options?.maxArrayLength ?? int_1.UINT32_MAX;
        this.maxMapLength = options?.maxMapLength ?? int_1.UINT32_MAX;
        this.maxExtLength = options?.maxExtLength ?? int_1.UINT32_MAX;
