...
;// ./src/Decoder.ts
var Decoder_addDisposableResource = (undefined && undefined.__addDisposableResource) || function (env, value, async) {
    if (value !== null && value !== void 0) {
        if (typeof value !== "object" && typeof value !== "function") throw new TypeError("Object expected.");
        var dispose, inner;
        if (async) {
...
var Decoder_disposeResources = (undefined && undefined.__disposeResources) || (function (SuppressedError) {
    return function (env) {
        function fail(e) {
            env.error = env.hasError ? new SuppressedError(e, env.error, "An error was suppressed during disposal.") : e;
            env.hasError = true;
...
class Decoder {
    ...
    decode(buffer) {
        ...
        try {
            ...
            // eslint-disable-next-line @typescript-eslint/no-unused-vars
            const _guard = Decoder_addDisposableResource(env_1, this.enteringGuard(), false);
            this.reinitializeState();
            this.setBuffer(buffer);
            ...
            Decoder_disposeResources(env_1);
        }
    }
    *decodeMulti(buffer) {
        const env_2 = { stack: [], error: void 0, hasError: false };
        try {
            ...
            // eslint-disable-next-line @typescript-eslint/no-unused-vars
            const _guard = Decoder_addDisposableResource(env_2, this.enteringGuard(), false);
            this.reinitializeState();
            this.setBuffer(buffer);
            ...
            Decoder_disposeResources(env_2);
        }
    }
    async decodeAsync(stream) {
        ...
        try {
            ...
            // eslint-disable-next-line @typescript-eslint/no-unused-vars
            const _guard = Decoder_addDisposableResource(env_3, this.enteringGuard(), false);
            let decoded = false;
            let object;
            ...
            Decoder_disposeResources(env_3);
        }
    }
    ...
    async *decodeMultiAsync(stream, isArray) {
        ...
        try {
            ...
            // eslint-disable-next-line @typescript-eslint/no-unused-vars
            const _guard = Decoder_addDisposableResource(env_4, this.enteringGuard(), false);
            ...
            Decoder_disposeResources(env_4);
        }
    }
    doDecodeSync() {
        DECODE: while (true) {
